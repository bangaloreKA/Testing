...
# #
# #             # Calculate all zodiac data
# #             allZodiacDataList_sign = Calculate.PlanetsInSign(ZodiacName.Aries, birth_time)
# #             allZodiacDataList_house = Calculate.HouseFromSignName(ZodiacName.Aries, birth_time)
# #
# #             # Convert the results to a readable format
# #             if allZodiacDataList_sign is not None:
# #                 planets_in_sign = [str(planet) for planet in allZodiacDataList_sign]
# #             else:
# #                 planets_in_sign = "No planets found"
# #
# #             if allZodiacDataList_house is not None:
# #                 house_from_sign = str(allZodiacDataList_house)
# #             else:
# #                 house_from_sign = "House name not found"
# #
...
# # import json
# # import os
# # from vedastro import GeoLocation, Time, Calculate, ZodiacName
# #
# # # Function to get place suggestions and geolocation data
# # def get_place_suggestions(query):
# #     api_key = "bd404b3ded074574b8eb61888b718c62"
...
#
#
# # code for getting the Dasa details in detail
# # ----------------------------------------------
# # -------------===================================
# # ====================================================
#
...
# #
# #             # Retrieve planet names from Dasa periods
# #             planet_names = []
# #             for dasa in allHouseDataList:
# #                 planet_names.append(PlanetName[dasa])
# #
# #             # Display calculated data
# #             st.write("### Calculated Zodiac Data")
# #
...
# #             st.write(house_from_sign)
# #
# #             st.write("#### Planet Names from Dasa Periods:")
# #             st.write(planet_names)
# #
# #         except Exception as e:
# #             st.error(f"An error occurred: {e}")
# #
...
#
#
# # version 2.1 this gives a table of the zodiac and the planets and the hosuse number
# # ----------------------------------------------------------------------------
# # ----------------------------------------------------------------------------
#
...
#
#
# # Version 2.3  this gives the table and the kundali
# # --------------------------------------------------------------------
# # ---------------------------------------------------------------------
# #
# import streamlit as st
...
# Version 3.3  this gives the table and the kundali along with prediction of planet and House && Planet
# and Zodiac
# --------------------------------------------------------------------
# ---------------------------------------------------------------------
#
...
# Version 4.1
# Planets and Zodiac sign matching
# ==========================================================================
# ==========================================================================
...
# # Function to get place suggestions and geolocation data
# def get_place_suggestions(query):
#     api_key = "bd404b3ded074574b8eb61888b718c62"  # Replace with your actual API key
#     url = f"https://api.opencagedata.com/geocode/v1/json?q={query}&key={api_key}&limit=5"
#     response = requests.get(url)
#     return response.json()
#
...
#             st.write(kundali_html, unsafe_allow_html=True)
#
#             # User-provided data with Disease, Remedy, and Comments
#             user_provided_data = [
#                 {"Zodiac Sign": "Libra", "Planets in Sign": "Sun", "Disease": "Akshi roga, Jwara, Bandhana, Shiroroga, Kushta", "Remedy": "आकृणेत mantrjapa", "Comments": "Surya Mahadasha"},
#                 {"Zodiac Sign": "Leo", "Planets in Sign": "Moon", "Disease": "Pandu", "Remedy": "Chandra aradhana as told", "Comments": "In navamsha kundali"},
#                 {"Zodiac Sign": "Pisces", "Planets in Sign": "Jupiter", "Disease": "Raktapitta, jwara, "
...
# version 4.4 for the Dasa calculation along with the zodiac and planet matching
# ====================================================================================
# ======================================================================================
# import streamlit as st
# import requests
...
#         {"Zodiac Sign": "Libra", "Planets in Sign": "Sun", "Disease": "Akshi roga, Jwara, Bandhana, Shiroroga, Kushta", "Remedy": "आकृणेत mantrjapa", "Comments": "Surya Mahadasha"},
#         {"Zodiac Sign": "Leo", "Planets in Sign": "Moon", "Disease": "Pandu", "Remedy": "Chandra aradhana as told", "Comments": "In navamsha kundali"},
#         {"Zodiac Sign": "Pisces", "Planets in Sign": "Jupiter", "Disease": "Raktapitta, jwara, daha, agnichaura upadrava", "Remedy": "अिनमूधत mantra japa; homa with Tila-Ajya-Khadira samit, vidruma dharana", "Comments": "In navamsha kundali"}
#     ]
#
# # Save user data to a JSON file
# def save_user_data(data, file_path='user_data.json'):
...
#         try:
#             TOBDOBGMT = f"{user['TimeofBirth']} {user['DateofBirth']} {user['gmt']}"
#             geolocation = GeoLocation(user["place"], longitude, latitude)
#             birth_time = Time(TOBDOBGMT, geolocation)
#
#             # Calculate zodiac data for all zodiac signs
#             zodiac_signs = {
